...
int main (int argc, char* argv[]) {
    ...
    Eigen::VectorXd desired_xddot = Eigen::VectorXd::Zero(6);
    // const int kp_base_position = 100;
    // const int kd_base_position = 2*sqrt(kp_base_position);
    // const int kp_base_orientation = 20;
    ...
    // Kp_base << kp_base_position, 0, 0, 0, 0, 0,
    //             0, kp_base_position, 0, 0, 0, 0,
    //             0, 0, kp_base_position, 0, 0, 0,
    //             0, 0, 0, kp_base_orientation, 0, 0,
    //             0, 0, 0, 0, kp_base_orientation, 0,
    //             0, 0, 0, 0, 0, kp_base_orientation;
    // Kd_base << kd_base_position, 0, 0, 0, 0, 0,
    //             0, kd_base_position, 0, 0, 0, 0,
    //             0, 0, kd_base_position, 0, 0, 0,
    //             0, 0, 0, kd_base_orientation, 0, 0,
    //             0, 0, 0, 0, kd_base_orientation, 0,
    //             0, 0, 0, 0, 0, kd_base_orientation;
    const int Kp_base = 100;
    ...
    for (int i=0; i<totalT; i++) {
        ...
        // if(i>20000 && i%50==0){
            ...
            raisim::Mat<3, 3> wRb_raisim;
            go1->getBaseOrientation(wRb_raisim);
            Eigen::Matrix3d wRb = wRb_raisim.e(); 

            // std::cout << "wRb size : " << wRb.rows() << " " << wRb.cols() << std::endl;
            auto base_orientation = wRb.eulerAngles(0, 1, 2); 
            ...
            // base_pose.tail(3) = wRb.eulerAngles(0, 1, 2);      
            ...
            desired_xddot = Kp_base*(desired_base_pose - base_pose) - Kd_base*(base_velocity);
            ...
            des_xddot.tail(6) = desired_xddot;
