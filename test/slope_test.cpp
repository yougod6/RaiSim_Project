...
int main (int argc, char* argv[]) {
    ...
    if(is_attached){
        ...
        auto pin2 = world.addBox(0.15, 0.5, 0.15, 1,"steel",raisim::COLLISION(2),raisim::COLLISION(2));
        pin2->setBodyType(raisim::BodyType::DYNAMIC);
        pin2->setPosition(ee_posi_tmp);
        // auto wire = world.addCompliantWire(pin, 0, {0,0,ccccc0}, robot, 0, {0., 0, 0}, 2.0, 1000);
